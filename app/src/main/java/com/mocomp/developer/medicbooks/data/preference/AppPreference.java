package com.mocomp.developer.medicbooks.data.preference;
...
public class AppPreference {
    ...
    public String getChatTextSize() {
        return mSettingsPreferences.getString(AppConstant.PREF_CHAT_FONT_SIZE, mContext.getResources().getString(R.string.default_text));
    }
