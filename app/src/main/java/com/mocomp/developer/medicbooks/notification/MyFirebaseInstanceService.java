...
import com.mocomp.developer.medicbooks.activity.CustomUrlActivity;
import com.mocomp.developer.medicbooks.activity.NotificationDetailsActivity;
...
/*
        ...
        if (remoteMessage.getData().size() > 0) {
            ...
            if (AppPreference.getInstance(MyFirebaseInstanceService.this).isNotificationOn()) {
 ...
 */
    ...
    /*private void sendNotification(String title, String messageBody, String url) {
        ...
        NotificationDbController notificationDbController = new NotificationDbController(MyFirebaseInstanceService.this);
